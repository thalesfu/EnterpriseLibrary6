...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder" runat="server">
    ...
    <div id="expenseform">
        ...
        <br />
            ...
            &nbsp;<cc1:PropertyProxyValidator ID="ExpenseTitleValidator" runat="server" ControlToValidate="ExpenseTitle" PropertyName="Title" SourceTypeName="AExpense.Model.Expense, AExpense">
        ...
        <p>
            ...
            <div style="float: left; display: inline-table">
                ...
                <asp:TextBox ID="ExpenseItemDescription" runat="server" MaxLength="100" />
                    &nbsp;<cc1:PropertyProxyValidator ID="ExpenseItemDescriptionValidator" runat="server" ControlToValidate="ExpenseItemDescription" PropertyName="Description" SourceTypeName="AExpense.Model.ExpenseItem, AExpense" ValidationGroup="AddNewExpenseItem"></cc1:PropertyProxyValidator>
                <br />
                <br />
                ...
                &nbsp;<cc1:PropertyProxyValidator ID="ExpenseItemAmountValidator" runat="server" ControlToValidate="ExpenseItemAmount" PropertyName="Amount" SourceTypeName="AExpense.Model.ExpenseItem, AExpense" ValidationGroup="AddNewExpenseItem" OnValueConvert="AmountValueConvert">
                </cc1:PropertyProxyValidator>
        ...
        <br />
            ...
            &nbsp;<cc1:PropertyProxyValidator ID="ExpenseApproverValidator" runat="server" ControlToValidate="Approver" PropertyName="ApproverName" SourceTypeName="AExpense.Model.Expense, AExpense">
            </cc1:PropertyProxyValidator>
        </p>
        <p>
