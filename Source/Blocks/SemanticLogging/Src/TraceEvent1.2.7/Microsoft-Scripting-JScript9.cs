...
namespace Diagnostics.Tracing.Parsers
{
    ...
    {
        public string TypeName { get { return GetUnicodeStringAt(0); } }
        public new string EventName { get { return GetUnicodeStringAt(SkipUnicodeString(0)); } }    // SLAB fix
    ...
    public sealed class JscriptWinRTEventHandlerAllocationTraceData : TraceEvent
    {
        ...
        public new string EventName { get { return GetUnicodeStringAt(HostOffset(SkipUnicodeString(HostOffset(4, 1))+4, 1)); } }    // SLAB fix
